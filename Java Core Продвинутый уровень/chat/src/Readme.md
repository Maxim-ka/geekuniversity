...
В принципе не важно какие задачи ставились/разбирались,
проект полностью перешел в самостоятельную разработку, 
дальнейшее продолжение работы [здесь](https://github.com/Maxim-ka/MyChat)